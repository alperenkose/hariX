...
-- -----------------------------------------------------
-- Table `bugware0`.`board_models`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bugware0`.`board_models` ;
...
-- -----------------------------------------------------
-- Table `bugware0`.`dev_board`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bugware0`.`dev_board` ;
...
-- -----------------------------------------------------
USE `bugware0`;
DROP procedure IF EXISTS `bugware0`.`sp_queryPcimap`;
...
-- -----------------------------------------------------
DROP VIEW IF EXISTS `bugware0`.`vw_pci_devices` ;
