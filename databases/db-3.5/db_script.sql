...
CREATE  TABLE IF NOT EXISTS `bugware0`.`pci_devices` (
  ...
  `deviceName` VARCHAR(150) NULL DEFAULT NULL ,
...
CREATE  TABLE IF NOT EXISTS `bugware0`.`pci_prog_ifs` (
  ...
  `progifName` VARCHAR(100) NULL DEFAULT NULL ,
...
CREATE  TABLE IF NOT EXISTS `bugware0`.`pci_subsystems` (
  ...
  `subdevice` CHAR(4) NULL DEFAULT NULL ,
  `subSysName` VARCHAR(150) NULL DEFAULT NULL ,
  `deviceID_FK` INT(10) UNSIGNED NOT NULL ,
  `uProgifID_FK` TINYINT(3) UNSIGNED NULL DEFAULT NULL ,
  PRIMARY KEY (`pciSpcID`) ,
  INDEX `fk_pci_subsystems_pci_devices1` (`deviceID_FK` ASC) ,
  INDEX `fk_pci_subsystems_pci_prog_ifs1` (`uProgifID_FK` ASC) ,
  CONSTRAINT `fk_pci_subsystems_pci_devices1`
    FOREIGN KEY (`deviceID_FK` )
    REFERENCES `bugware0`.`pci_devices` (`deviceID` )
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_pci_subsystems_pci_prog_ifs1`
...
CREATE  TABLE IF NOT EXISTS `bugware0`.`all_devices` (
  ...
  PRIMARY KEY (`uDevID`) ,
  INDEX `fk_all_devices_pci_subsystems1` (`pciSpcID_FK` ASC) ,
  ...
  CONSTRAINT `fk_all_devices_bus_type1`
    ...
    ON UPDATE CASCADE,
  CONSTRAINT `fk_all_devices_pci_subsystems1`
    FOREIGN KEY (`pciSpcID_FK` )
    REFERENCES `bugware0`.`pci_subsystems` (`pciSpcID` )
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;
...
CREATE  TABLE IF NOT EXISTS `bugware0`.`os_revisions` (
  ...
  `revisionName` VARCHAR(45) NULL DEFAULT NULL ,
...
CREATE  TABLE IF NOT EXISTS `bugware0`.`kernels` (
  ...
  `kernelVersion` VARCHAR(45) NULL DEFAULT NULL ,
...
CREATE  TABLE IF NOT EXISTS `bugware0`.`dev_mod` (
  ...
  `works` TINYINT(1) NULL DEFAULT NULL ,
